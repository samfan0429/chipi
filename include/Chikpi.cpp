...
{
    piano.push_back(new Chikorita("10E",700.f,450.f,60)); //60 is threshold
    piano.push_back(new Chikorita("9D",200.f,450.f,60));
    piano.push_back(new Chikorita("8C",930.f,620.f,395)); //395 is threshold
    piano.push_back(new Chikorita("7B",700.f,620.f,395)); 
    piano.push_back(new Chikorita("6A",160.f,620.f,395)); 
    piano.push_back(new Chikorita("5G",960.f,630.f,455)); //455 is threshold
    piano.push_back(new Chikorita("4F",780.f,630.f,455)); 
    piano.push_back(new Chikorita("3E",550.f,630.f,455));
    piano.push_back(new Chikorita("2D",330.f,630.f,455));
    piano.push_back(new Chikorita("1C",0.f,630.f,455));
}
